...
{
    public class Generation6Keyboard : AbstractKeyboard
    {
        public override string Name { get; } = "Generation 6 (X, Y, Omega Ruby and Alpha Sapphire)";

        public override string ShortKey { get; } = "6";
